...
from app.services.student_campus_state_service import StudentCampusStateService
from app.services.student_access_log_service import StudentAccessLogService 
...
class StudentExitService:
    ...
    def __init__(self):
        ...
        self._state = StudentCampusStateService() 
        self._log = StudentAccessLogService() 
