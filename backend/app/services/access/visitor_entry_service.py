...
from app.services.visitor_campus_state_service import VisitorCampusStateService
from app.services.visitor_access_log_service import VisitorAccessLogService
...
class VisitorEntryService:
    ...
    def __init__(self):
        ...
        self._state = VisitorCampusStateService()
        self._log = VisitorAccessLogService()
